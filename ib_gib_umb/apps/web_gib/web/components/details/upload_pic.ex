defmodule WebGib.Web.Components.Details.UploadPic do
  ...
  component :upload_pic_details do
    ...
    div [id: "ib-pic-details", class: "ib-details-off"] do
      ...
      div [id: "ib-pic-details-unauthorized", class: "ib-height-100"] do
        div [id: "ib-pic-details-unauthorized-help", class: "ib-height-100"] do
          
        end
      end
      
      div [id: "ib-pic-details-authorized", class: "ib-hidden"] do
