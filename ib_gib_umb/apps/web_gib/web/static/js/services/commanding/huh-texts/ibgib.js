...
For starters, you can think of them as "things" or to be more Carlinesque: "stuff". So you can add your stuff, change your stuff, and relate your stuff to each other. In the future you can be reminded of stuff and helped with stuff, learn stuff, and basically do and share stuff.

### :nerd_face: :grey_question:

* The ibGib engine is currently implemented in Elixir which sits on top of Erlang's BEAM for its parallel architecture.
* Each ibGib "frame" is the immutable state describing a pure function.
  * Each ibGib timeline allows for mut8ns.
  * Each "new" ibGib frame is created by an ibGib pure function frame coming into contact with another ibGib pure function frame.
...
ibGib works like life works: Every ibGib has DNA, an ancestry, a past, and relationships (rel8ns) with other ibGib. So learning about ibGib can help you understand the relationship we have with DNA, evolution, neurons, and information.
